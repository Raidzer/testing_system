      ...
      <StyledRoot>
        ...
        <StyledContent>
          <Routes>
            ...
            <Route path="/:idTheme" element={<Lesson />} />
            <Route path="/statistics" element={<UserStatistics />} />
            <Route path="/search" element={<SearchResult />} />
            <Route
              path="/administrator/theme"
              element={userIsAdmin ? <AdministratorPanelTheme /> : <NotFound />}
            />
            <Route
              path="/administrator/theme/:idTheme/questions"
              element={
                userIsAdmin ? <AdministratorPanelQuestion /> : <NotFound />
              }
            />
            <Route
              path="/administrator/theme/:idTheme/articles"
              element={
                userIsAdmin ? <AdministratorPanelArticle /> : <NotFound />
              }
            />
            <Route
              path="/administrator/theme/:idTheme/articles/:idArticle"
              element={userIsAdmin ? <ArticleEditor /> : <NotFound />}
            />
            <Route
